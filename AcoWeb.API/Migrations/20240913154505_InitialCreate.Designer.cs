...
namespace AcoWeb.API.Migrations
{
    ...
    [Migration("20240913154505_InitialCreate")]
            ...
            modelBuilder.Entity("AcoWeb.API.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Antonio",
                            HireDate = new DateTimeOffset(new DateTime(2019, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LastName = "P Summers",
                        ...
                        new
                        {
                            ...
                            FirstName = "Colton",
                            HireDate = new DateTimeOffset(new DateTime(2022, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LastName = "Minton",
                            OfficeId = new Guid("5ab77607-42e8-4a25-b47a-db8983a652e8"),
